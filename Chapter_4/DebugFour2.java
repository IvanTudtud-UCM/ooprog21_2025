...
public class DebugFour2
{
    public static void main(String args[])
    {
        ...
        display(pen2);  // Fixed typo from 'pen22' to 'pen2'
    }

    public static void display(DebugPen p)  // Fixed parameter type from 'FixDebugPen' to 'DebugPen'
    {
        System.out.println(" The pen has ink color " + p.getColor());
        System.out.println(" and a " + p.getPoint() + " point.");  // Fixed 'p1.getPoint()' to 'p.getPoint()'
    }
}
